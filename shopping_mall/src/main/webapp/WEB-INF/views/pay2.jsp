...
주소 : <input type="text" name="rec_post" maxlength="5" value="01835"><br>
	  <input type="text" name="rec_way" placeholder="도로명주소" value="서울특별시 노원구 공릉로41나길 28"><br>
	  <input type="text" name="rec_addr" placeholder="상세주소" value="104호"><br> 
<p>결제방식</p>
