...
<%
	...
	Random rd = new Random();	//Random class 이용
...
상품명 : <input type="text" name="product_nm" readonly="readonly" value="중앙컴퓨터"><br>
...
총결제금액 : <input type="text" name="price" value="10000" readonly="readonly"><br>
